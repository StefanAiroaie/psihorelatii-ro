...
**Critica cronică.** În cercetările Gottman, cuplurile stabile mențin un raport pozitiv:negativ de cel puțin 5:1 în interacțiunile zilnice — adică cel puțin cinci interacțiuni pozitive pentru fiecare una negativă. La cuplurile care își pierd pasiunea, raportul scade adesea sub 1:1 (mai multe reproșuri decât aprecieri), iar creierul ajunge să înregistreze partenerul ca o sursă de amenințare, nu de plăcere. Pentru identificarea tiparelor toxice, articolul despre [greșeli frecvente în relația de cuplu](/relatii/greseli-frecvente-in-relatiile-de-cuplu-si-cum-sa-le-eviti) aprofundează acest aspect.
...
### Pasul 2: Repară relația înainte de a o revigora
...
Poate fi o cină fără subiecte logistice, o plimbare lungă, un masaj reciproc, un dans în living. Ideea e ca acest timp să **redevină spațiu erotic, nu doar zonă funcțională**. Un [time blocking practic pentru cuplu](/psihologie-practica/time-blocking-in-cuplu) te ajută să blochezi efectiv aceste ore în calendar.
...
- există un dezacord fundamental asupra intimității (unul vrea activ, celălalt evită constant mai mult de 6 luni);
